...
# ================= 🎨 終極全方位 CSS（徹底殲滅貓咪、工具列與所有按鈕） =================
st.markdown("""
    <style>
        /* 🎯 必殺技：精準點名最新版 Streamlit 的全域工具列與所有官方按鈕，強制集體蒸發 */
        header, 
        ...
        with st.spinner("AI 正在專業整理中，請稍候..."):
            try:
                ...
                if format_type == "SOAP":
                    ...
                    system_instruction = """
                    你是一位精通精神醫療科（Psychiatric Ward）與一般內外科臨床護理的資慢護理師。
                ...
                # 這裡已經徹底修正為純字串，絕不會再發生 f-string 錯誤！
