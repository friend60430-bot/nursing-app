...
# ================= 🎨 幕後 CSS 控制（文字放大 ＆ 實心蓋板除貓法） =================
st.markdown("""
    <style>
        /* 🎯 終極蓋板：在按鈕區塊上方疊一個純白色、點不到的方塊，直接把貓咪永久封印 */
        header [data-testid="stHeaderButtons"] {
            position: relative !important;
        }
        header [data-testid="stHeaderButtons"]::after {
            content: "" !important;
            position: absolute !important;
            top: 0 !important;
            right: 36px !important; /* 精準覆蓋右側第二個按鈕（貓咪位置） */
            width: 38px !important;
            height: 100% !important;
            background-color: #ffffff !important; /* 實心純白覆蓋 */
            z-index: 99999 !important;
            pointer-events: auto !important; /* 攔截滑鼠事件，讓底下完全無法被點擊 */
        }
        ...
        with st.spinner("AI 正在專業整理中，請稍候..."):
            try:
                ...
                if format_type == "SOAP":
                    ...
                    4. P (Plan): 記錄執行的護理措施與計畫（如：續防自殺/維持安全、加強防跌注意事項、加強規則服藥與防吐藥衛教、給予傾聽或安撫、維持約束/尿管照護、持續追蹤各項生理指標與 data、準備出院護理指導等）。
